...
<html lang="en">
    ...
    <body>
        <?php 
            ...
            $first_name=$last_name=$email=$country=$occupation=$year_of_experience=$professional_experience=$salary=$skills="";
                    ...
                    <?php 
                        ...
                        if(isset($_POST["update"]) && isset($first_name) && isset($last_name) && isset($email) && isset($country) && isset($occupation) && isset($year_of_experience)&& isset($salary)&& isset($skills)&&isset($professional_experience)){
                            if($first_name_err=="" && $last_name_err=="" && $country_err=="" && $email_err==""&& $occupation_err=="" && $year_of_experience_err=="" && $salary_err=="" && $skills_err==""&& $professional_experience_err==""){
                                ...
                                $sqlstring="INSERT INTO engineer(first_name,last_name,email,country,occupation,year_of_experience,salary,skills,professional_experience)VALUES( '$first_name','$last_name','$email','$country','$occupation','$year_of_experience','$salary','$skills','$professional_experience')";
