...
<meta charset="utf-8" />
        ...
        <link rel="stylesheet" type="text/css" href="style/contactus_style.css">
                        ...
                        <div class="controls">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a onclick="window.open('index.php')"><input type="submit" name="submit" class="btn btn-success btn-send" value="Live Chat"></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
